...
domain = "road-to-lens-rosy.vercel.app"
full_url = "https://road-to-lens-rosy.vercel.app/"
...
#print(answer_question(df, question="Who has the most followers?", debug=False))

print("Question: Who is talking about ETH Tokyo?\n")

print("Answer from OpenAI: ")
print(answer_question(df, question="Who is talking about ETH Tokyo?"))